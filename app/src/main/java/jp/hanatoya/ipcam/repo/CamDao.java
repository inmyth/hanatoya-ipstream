...
public class CamDao extends AbstractDao<Cam, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Cam entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Cam entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Cam entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(Cam entity) {
